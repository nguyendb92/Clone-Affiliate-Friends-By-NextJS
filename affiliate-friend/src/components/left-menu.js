                        ...
                        <div className="sidebar-nav navbar-collapse">
                            <ul className="nav" id="side-menu">
                                ...
                                <li className="app-auth module ">
                                    <a href="#">
                                        会員一覧<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse " aria-expanded="false">
                                        ...
                                        <li>
                                            <a href="/admin/auth/member/via_friend/import_csv?action=delete">フレンズ経由登録
                                                削除</a>
                                        </li>
                                    </ul>
                                </li>
                                <li className="app-django_celery_results module">
                                    <a href="#" title="Celery Results アプリケーション内のモデル">
                                        Celery Results<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                ...
                                <li className="app-notifications module">
                                    <a href="#" title="Notifications アプリケーション内のモデル">
                                        Notifications<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                ...
                                <li className="app-django_celery_beat module">
                                    <a href="#" title="Periodic Tasks アプリケーション内のモデル">
                                        Periodic Tasks<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                ...
                                <li className="app-special_price_applicants module">
                                    <a href="#" title="Special_Price_Applicants アプリケーション内のモデル">
                                        Special_Price_Applicants<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                ...
                                <li className="app-user_details module">
                                    <a href="#" title="User_Details アプリケーション内のモデル">
                                        User_Details<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                ...
                                <li className="app-special_prices module">
                                    <a href="#" title="特単 アプリケーション内のモデル">
                                        特単<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
                                        <li className="model-g">
                                            <a href="/admin/special_prices/genres/">ジャンル</a>
                                        </li>
                                        <li className="model-s">
                                            <a href="/admin/special_prices/specialprices/">フレンズ特単管理</a>
                                        </li>
                                    </ul>
                                </li>
                                <li className="app-auth module">
                                    <a href="#" title="アカウント管理 アプリケーション内のモデル">
                                        アカウント管理<span className="arrow">
                                        <FontAwesomeIcon icon={faChevronLeft}  size="sm" style={{width: "9px", heght:"14px"}}/>
                                    </span>
                                    </a>
                                    <ul className="nav nav-second-level collapse" aria-expanded="false">
